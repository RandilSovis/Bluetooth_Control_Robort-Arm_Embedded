...
TCCR1A = 0; // disable all PWM on Timer1 whilst set it up 
TCCR1B=0; 
ICR1 = 3749; 
TCCR1A = (1<<WGM11); 
...
angle = 178; //Gripper// 
OCR1A = 270; //shoulder// INITIALIZE THE MOTOR AT 50 ANGEL 
_delay_ms(1000); 
OCR0 = 150; //elbow //INITIALIZE THE MOTOR AT 0 ANGEL 
_delay_ms(1000); 
OCR2 = 68; //wrist roll //INITIALIZE THE MOTOR AT 0 ANGEL 
_delay_ms(1000); 
OCR1B = 178; //waist //INITIALIZE THE MOTOR AT 0 ANGEL 
_delay_ms(1000); 
//////////////////////////////////////////////////// 
while(1) 
{ 
...
_delay_ms(80); 
char str[16]; 
USART_SendString(itoa(OCR2,str,10)); 
} 
...
_delay_ms(50); 
char str[16]; 
USART_SendString(itoa(OCR0,str,10)); 21 
